...
export function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Plateforme de vente en ligne spécialisée dans les montres, avec gestion de catalogue, panier, paiement sécurisé via Stripe et suivi des commandes.",
    ...
    
    {
      ...
      github: "https://github.com/Aymannnn404",
      competences: ["Développer pour mobile", "Intégrer une base de données temps réel", "Créer une interface intuitive pour la réservation"],
